...
export class SongFormComponent implements OnInit {
  ...
  public getStyles(event?: any): void {
  ...
  public getAlbums(event?: any): void {
  ...
  public getArtists(event?: any): void {
  ...
  private getSongById(songId: number): void {
    this.songService.getSongById(songId).subscribe({
      next: (songRequest:any) => {
        ...
        this.selectedAlbum = new Album(songRequest.albumId!, songRequest.albumName!);
